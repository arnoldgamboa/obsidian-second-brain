---
tags: [linkedin, engagement, power-list, ai-employee]
created: 2026-07-02
status: active
...
This is the human-readable source of truth for the daily LinkedIn engagement cron.

The cron should prioritize this list before broad LinkedIn/topic search. Broad search is only a fallback when the power list does not produce enough good recent posts.

## Target mix

- 70% small-business operators / founders / owners
- 20% adjacent operators / agencies / consultants / fractional leaders
- 10% practical AI professionals / builders

## Field guide

- **Priority**: A = check often; B = rotate regularly; C = occasional/fallback.
- **Category**: operator-founder, agency-consultant, ops-systems, revops-gtm, practical-ai, creator-operator.
- **Status**: candidate, active, paused, remove.
- **Last engaged**: update after an approved comment is actually posted, not merely suggested.

## Seed candidates from previous cron outputs

These names came from previous LinkedIn engagement cron runs. They are useful starting candidates, but should be verified and adjusted. Do not over-index on AI/tool posts; promote people only if their audience and posts match Arnold's buyer strategy.
...
These targets came from public LinkedIn/web search results on 2026-07-02. Treat them as `candidate` until the cron confirms they are posting recent, relevant content.

### Small-business operators / founders / owner-audience targets
...
| B | candidate | Brian Wirtz | https://www.linkedin.com/in/briandwirtz | Operations leadership candidate. | growth systems; process maturity; execution cadence | |

### Practical AI / workflow automation targets

Use this bucket sparingly. Include only when the post has a clear operator/business-workflow angle.
...
| C | candidate | Kiefer Hazaz | https://www.linkedin.com/in/kiefer-hazaz | RevOps/data hubs/AI workflow systems. | disconnected systems; data hubs; workflow orchestration | |
| C | candidate | Natalie Furness | https://uk.linkedin.com/in/nataliefurness | Revenue operations candidate; include when posts have practical workflow value. | RevOps; pipeline process; system follow-through | |

## Cron instructions summary
